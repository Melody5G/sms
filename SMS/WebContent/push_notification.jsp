...
<%
    ...
    String simpleApiKey = "AAAA6kZnL_Y:APA91bF4Jqs4f-w8gwwOGh-mFLzkZPLAeNCwKxIMPBihoGg0Cd_niCiHyFEPmugMJOZOnfaM4fQB8wBdheRJ0X_7-SlaGpr-SnCaZlZIDLUdkdYLu5PtfmmCK_maQSUcoXkgJ5Gjlfz4";
    ...
    //msg = new String(msg.getBytes("UTF-8"), "UTF-8");   //메시지 한글깨짐 처리
     ...
     try {
        ...
        conn=DriverManager.getConnection("jdbc:mysql://localhost:3306/fcm?autoReconnect=true&useSSL=false","root","soo1194");
        //db연결 
